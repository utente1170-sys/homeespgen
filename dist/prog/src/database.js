...
class Database {
  ...
  `;
    ...
    getGeneralMonthlyStatsByDateRange(startDate, endDate) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
        ...
        GROUP BY yearMonth
      `;
                this.db.all(sqlSensor, [startTimestamp, endTimestamp], (err, sensorRows) => {
                    if (err) {
                        reject(err);
                    }
                    else {
          ...
          `;
                        ...
                        this.db.all(sqlBackup, [startYearMonth, endYearMonth], (err2, backupRows) => {
                            if (err2) {
                                reject(err2);
                            }
                            else {
