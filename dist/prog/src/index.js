...
app.use('/api/prodotti', prodotti_1.default);
/************************************************** */
/****************************************************************** */
...
app.get('/spending-dashboard', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (startDate && endDate) {
            ...
            monthlyStats = yield database_1.database.getGeneralMonthlyStatsByDateRange(startDate, endDate);
        }
        else {
            // Altrimenti usa la funzione normale
            ...
            monthlyStats = yield database_1.database.getGeneralMonthlyStatsByDateRange(startDateDefault, endDateDefault);
        }
        // Ottieni tutti i possessori dei tag per mostrare i nominativi
        const tagOwners = yield database_1.database.getAllTagOwners();
        // Crea una mappa per accesso rapido ai possessori per UID
...
function generateGeneralSpendingDashboard(stats, tagOwnersMap, pagination, globalTotals, filters, monthlyStats) {
...
function generateUtilityPage(data) {
  ...
  `;
    return (0, helpers_1.generateBaseHTML)('Utility e Impostazioni', 'utility', content, additionalStyles);
}
