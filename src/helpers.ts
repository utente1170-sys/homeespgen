...
export function generateCSSLink(): string {
...
export function generateStickyHeaderScript(): string {
  return `
...
export function generateAutoRefreshScript(): string {
  return `
...
export function generateBaseHTML(title: string, activePage: string, content: string, additionalStyles: string = '', additionalScripts: string = ''): string {
  return `
<!DOCTYPE html>
<html lang="it">
<head>
...
export function generateSearchSection(searchId: string, placeholder: string, clearFunction: string): string {
  return `
...
export function generateTastierinoNumerico(
  targetInputId: string,           // ID della textbox numerica a cui il tastierino deve scrivere
  confirmFunction: string,         // Funzione JavaScript da chiamare quando si clicca "Conferma"
  addFunction: string,             // Funzione JavaScript da chiamare quando si clicca "Aggiungi"
  removeFunction: string,          // Funzione JavaScript da chiamare quando si clicca "Togli"
  causaleInputId: string = "causaleInput", // ID della textbox per la causale
  causalePlaceholder: string = "Inserisci causale" // Placeholder per la textbox causale
): string {
  return `
...
export function disattivaScript(btnid:string,disattivaFunction:string):string {
...
export function checkServer(btnid:string,chekServer:string):string {
...
export function generateSearchScript(searchId: string, clearFunction: string): string {
  return `
...
export function generateDateRangeControls(startDateId: string = 'startDate', endDateId: string = 'endDate', applyFunction: string = 'applyDateFilter', filterIndicatorHtml: string = ''): string {
  return `
...
export function generateSearchSectionWithDateFilter(
  searchId: string, 
  placeholder: string, 
  clearFunction: string,
  startDateId: string = 'startDate',
  endDateId: string = 'endDate',
  applyFunction: string = 'applyDateFilter'
): string {
  return `
...
export function formatDateIta(dateString: string): string {
...
export function generateDateFilterIndicator(startDate?: string, endDate?: string): string {
  if (startDate && endDate) {
    return `
